<header>
    <div id="container26" class="default full screen" style="--onvisible-speed: 1s; --onvisible-background-color: rgba(0,0,0,0.001); min-height: 250px; background-position-y: -200px;">
        ...
        <div class="container mt-5" style="position:relative; z-index:1;">
            <div class="row text-white">
                ...
                <div class="col-md-8 text-white">
                    <!-- Left-side content -->
                    <h1 class="t181__title t-title t-title_md studio" style="font-weight: 600; position:absolute; top:-40px;">Stundenplan</h1>
                </div>
