...
<div id="container19" class="style4">
    <div class="row" style="max-width: 100vw;">
        ...
        <div class="style1" style="padding:20px 50px;">
            ...
            <p id="text15" class="style3">Bei der Gründung von YYoga wollten wir, dass sich unsere Kunden hier so wohl wie möglich fühlen. Wir haben viel Mühe und Energie investiert, um einen schönen, komfortablen und technologisch fortschrittlichen Raum zu schaffen. Wenn Sie zu uns kommen, werden Sie sich immer als willkommener Gast fühlen.</p>
        </div>
        </div>
        <!-- Image Column -->
  ...
  <div id="container01" class="style1 container default">
        <div class="wrapper">
            <div class="inner">
                <h2 id="text17" class="style1">Accumsan sit amet</h2>
                <p id="text49" class="style3">Quam elementum pulvinar etiam non quam lacus suspendisse faucibus interdum. Pretium quam vulputate dignissim suspendisse in est ante.</p>
            </div>
        </div>
    </div>
