    ...
    <wrapper>
        <header>
            <div id="container26" class="default full screen"
                style="--onvisible-speed: 1s; --onvisible-background-color: rgba(0,0,0,0.001);">
                ...
                <div class=".wrapper__My" style="max-width: 1160px; margin:0 auto;">
                    <nav class="navbar navbar-expand-lg navbar-white bg-white">
                        ...
                        <button class="navbar-toggler btn__header" type="button" data-toggle="collapse"
                        ...
                        <div
                            class="d-flex flex-column align-items-center ml-lg-4 mobilePhone_Email mobilePhone_Email__top">
                            ...
                            <a href="https://www.instagram.com/yoga_im_atelier_salzwedel/" target="_blank"
                                class="mt-2 sp-black sp-black-inst">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('admin.')}}">Preise</a>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-horizontal" aria-labelledby="yogaDropdown">
                                        <a class="dropdown-item" href="{{ route('ersteschritte') }}">Erste Schritte im
                                            Yoga</a>
                                        <a class="dropdown-item" href="{{ route('yogaNastik') }}">Yoganastik</a>
                                        <a class="dropdown-item" href="{{ route('fasziNastik') }}">Faszinastik</a>
                        ...
                        <!-- Добавляем мобильный телефон, email и значок Instagram -->
                        <div
                            class="d-flex flex-column align-items-center ml-lg-4 mobilePhone_Email mobilePhone_Email__bottom">
                            <div class="d-flex align-items-center">
                                <i class="fas fa-phone-alt mr-2 i-black"></i>
                                <span class="sp-black">+49 1512 7138054</span>
                            </div>
                    ...
                    <div class="layout-content">
                        ...
                        <p>Online-Streitbeilegung gemäß Art. 14 Abs. 1 ODR-VO:
                            ...
                            Sie unter <a
                                ...
                                https://ec.europa.eu/consumers/odr/ </a> finden. </p>
