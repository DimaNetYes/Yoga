...
class AdminPriceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'punkt4' => 'nullable|string', // Add validation for new point
            'punkt5' => 'nullable|string', // Add validation for new point
        ...
        $price = new Price([
            ...
            'punkt4' => $request->input('punkt4'), // Add new point
            'punkt5' => $request->input('punkt5'), // Add new point
    ...
    public function update(Request $request, $id)
    {
        ...
        $price->punkt4 = $request->input('punkt4'); // Update for new point
        $price->punkt5 = $request->input('punkt5'); // Update for new point
